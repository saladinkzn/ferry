...
public class RequestExecutorTest {
    ...
    public void testBuildHttpRequest() {
        ...
        final ExecutionHelper<Object> requestExecutor = new ExecutionHelper<>(client, "GET", Sets.newHashSet("param1", "param2"), "http://example.com", null, ImmutableMap.of(0, "param1", 1, "param2"));
